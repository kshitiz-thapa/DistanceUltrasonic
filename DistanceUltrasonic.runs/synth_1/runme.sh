...
HD_PWD='C:/Users/kshit/Documents/Labs 3730/DistanceUltrasonic/DistanceUltrasonic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainSrc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainSrc.tcl
