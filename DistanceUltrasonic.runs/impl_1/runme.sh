...
HD_PWD='C:/Users/kshit/Documents/Labs 3730/DistanceUltrasonic/DistanceUltrasonic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainSrc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainSrc.tcl -notrace
